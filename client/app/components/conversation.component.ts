...
export class ConversationComponent implements OnInit { 
    ...
    generateSystemConversations(event, message:string, action:string, name:string, towatson:any) {
        this.SystemConversation = false;
        var conversation_length = this.conversation.length;
        var lastContext = this.conversation[conversation_length - 1].context;
    ...
    updateConversationUi(sender:any, text:string, user_class:string, context) {   
        var curr_convo = {};
        if(user_class == "image") {
    ...
    fetchDefaultHelpButtons() {
        return {ButtonText: "I can help you with any of these things.", ButtonParams: ["Create a new bank account", "Top up your mobile", "Pay your bills"]}
    }
